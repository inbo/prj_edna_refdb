...
obi ecopcr -e 5 -l 20 -L 100 -F ACACCGCCCGTCACTCT -R CTTCCGGTACACTTACCATG --taxonomy refdb/taxonomy/dump refdb/input refdb/ecopcr
...
obi build_ref_db -t 0.96 --taxonomy refdb/taxonomy/dump refdb/ecopcr_uniq_clean refdb/ecopcr_final_0.96
...
grep -E  -i '>'  final_db_1.fasta | wc -l >> logfile.txt
